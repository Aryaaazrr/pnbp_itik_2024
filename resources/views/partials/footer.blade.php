        ...
        <div class="flex flex-wrap justify-between w-full lg:flex-nowrap">
            ...
            <div class="flex flex-col items-center justify-end w-full lg:flex-row">
                ...
                <div class="w-full px-4 mb-12 md:w-1/3 lg:h-32">
                    ...
                    <ul class="text-dark text-center">
                        <li>
                            <a href="/" class="inline-block text-base hover:text-primary mb-3 duration-500">Jl. Mastrip Po. Box 164, Kec. Sumbersari, Kab. Jember Jawa Timur, Indonesia 68121</a>
                        </li>
                    </ul>
                </div>
                <div class="w-full px-4 mb-12 md:w-1/3 lg:h-32">
                    ...
                    <ul class="text-dark text-center">
                        <li>
                            <a href="/" class="inline-block text-base hover:text-primary mb-3 duration-500">Ingin
                                update ternak usaha itik? Kik berikut</a>
                        </li>
                    </ul>
                    <ul class="text-dark text-center">
                        <li>
