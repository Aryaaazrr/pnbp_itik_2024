...
@section('content')
    ...
    <div class="bg-white p-4 mb-4 border-2 border-white rounded-lg">
        <div class="flex justify-center items-center rounded-lg border-gray-300 dark:border-gray-600 h-4">
            <h2 class="flex items-center justify-center text-lg font-bold">Analisis Usaha Layer Itik</h2>
        </div>
    </div>
    ...
    <script>
        function openTab(evt, tabName, periode) {
            ...
            // Mengubah teks tombol "Simpan" pada periode ke-6
            if (periode === 6) {
        ...
        function handleSubmit(event, periode) {
            ...
            // Setelah periode ke-6, ubah teks tab menjadi "Analisis"
            if (periode === 6) {
