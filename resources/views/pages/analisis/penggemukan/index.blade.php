...
@section('content')
    ...
    <div class="bg-white p-4 mb-4 border-2 border-white rounded-lg">
        <div class="flex justify-center items-center rounded-lg border-gray-300 dark:border-gray-600 h-4">
            <h2 class="flex items-center justify-center text-lg font-bold">Analisis Usaha Penggemukan Itik</h2>
        </div>
    </div>
    ...
    <script>
        function openTab(evt, tabName, periode) {
            ...
            if (periode === 4) {
                document.getElementById('submit-button-4').innerText = 'Simpan dan Mulai Analisis';
            } else {
                document.getElementById('submit-button-4').innerText = 'Simpan dan Lanjutkan';
            }
        }
        ...
        function handleSubmit(event, periode) {
            ...
            if (periode === 4) {
                document.getElementById('tab-4').innerText = 'Analisis';
            }
        }
