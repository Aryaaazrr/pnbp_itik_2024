...
@section('content')
    <div class="antialiased bg-secondary dark:bg-gray-900">
        <main class="p-4 md:ml-64 h-auto pt-20">
            ...
            <div class="bg-white p-4 mb-4 border-2 border-white rounded-lg">
                <div class="flex justify-center items-center rounded-lg border-gray-300 dark:border-gray-600 h-4">
                    <h2 class="flex items-center justify-center text-lg font-bold">Pilihan Menu</h2>
                </div>
            </div>
            ...
            <div class="bg-white p-4 border-2 border-white rounded-lg">
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                    <div
                        class="flex justify-center bg-primary rounded-lg dark:border-gray-600 h-32 md:h-64">
                        <div class="flex flex-col justify-center items-center">
                            <h1 class="flex justify-center w-full text-2xl font-bold text-white">Penetasan</h1>
                    ...
                    <div
                        class="flex justify-center border-2 bg-white border-gray-300 rounded-lg dark:border-gray-600 h-32 md:h-64">
                    </div>
                    <div
                        class="flex justify-center border-2 bg-white border-gray-300 rounded-lg dark:border-gray-600 h-32 md:h-64">
                    </div>
